...
void gateServer::registerHandler()
{
    ...
    csLoginHandlerMap[protocol::csmsg::CSLoginMsgType::EN_PLAYER_LOGIN] = std::bind(&gateServer::csLogin, this, _1, _2, _3);
    csLoginHandlerMap[protocol::csmsg::CSLoginMsgType::EN_PLAYER_LOGOUT] = std::bind(&gateServer::csLogout, this, _1, _2, _3);
    csMsgHandlerMap[protocol::csmsg::CSMsgType::EN_LOGIN] = std::bind(&gateServer::loginMsgHandler, this, _1, _2, _3, _4);
    csChatHandlerMap[protocol::csmsg::CSChatMsgType::EN_SEND] = std::bind(&gateServer::csSendChatMsg, this, _1, _2, _3);
    csChatHandlerMap[protocol::csmsg::CSChatMsgType::EN_HISTORY] = std::bind(&gateServer::csPullHistoryChatMsg, this, _1, _2, _3);
    csMsgHandlerMap[protocol::csmsg::CSMsgType::EN_CHAT] = std::bind(&gateServer::chatMsgHandler, this, _1, _2, _3, _4);
    csChannelHandlerMap[protocol::csmsg::CSChannelMsgType::EN_CREATE] = std::bind(&gateServer::csCreateChannel, this, _1, _2, _3);
    csChannelHandlerMap[protocol::csmsg::CSChannelMsgType::EN_DESTROY] = std::bind(&gateServer::csDestroyChannel, this, _1, _2, _3);
    csChannelHandlerMap[protocol::csmsg::CSChannelMsgType::EN_JOIN] = std::bind(&gateServer::csJoinChannel, this, _1, _2, _3);
    csChannelHandlerMap[protocol::csmsg::CSChannelMsgType::EN_LEAVE] = std::bind(&gateServer::csLeaveChannel, this, _1, _2, _3);
    csChannelHandlerMap[protocol::csmsg::CSChannelMsgType::EN_CHANNELMSG_SEND] = std::bind(&gateServer::csSendChannelMsg, this, _1, _2, _3);
    csChannelHandlerMap[protocol::csmsg::CSChannelMsgType::EN_PULL] = std::bind(&gateServer::csPullChannelList, this, _1, _2, _3);
    csMsgHandlerMap[protocol::csmsg::CSMsgType::EN_CHANNEL] = std::bind(&gateServer::channelMsgHandler, this, _1, _2, _3, _4);
    ssChatMsgHandlerMap[protocol::sschatmsg::SSChatMsgType::EN_RECEIVE] = std::bind(&gateServer::ssPushChatMsg, this, _1, _2, _3);
    ssMsgHandlerMap[protocol::ssmsg::SSMsgType::EN_CHAT] = std::bind(&gateServer::ssChatMsgHandler, this, _1, _2, _3, _4);
    ssChannelMsgHandlerMap[protocol::sschannelmsg::SSChannelMsgType::EN_RECEIVE] = std::bind(&gateServer::ssPushChannelMsg, this, _1, _2, _3);
    ssMsgHandlerMap[protocol::ssmsg::SSMsgType::EN_CHANNEL] = std::bind(&gateServer::ssChannelMsgHandler, this, _1, _2, _3, _4);
}
    ...
    std::string& response)
{
    ...
    auto [res, _] = createBaseMsg(protocol::common::MsgType::EN_MSG_TYPE_CS,
...
TFuture<void> gateServer::afterSocket(NNet::TUring::TSocket& socket)
{
    ...
    logger->debug("current client coroutines size: {},current connected clients size: {},current active players size: {}",
        clientStates.size(), connectedClients.size(), activePlayers.size());
